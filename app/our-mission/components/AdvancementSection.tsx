  ...
  const advanceSectionData = [
    {
      ...
      description:
        "Supporting victims of hate crime, prejudice, or discrimination through advice, advocacy, or referral services.",
    ...
    },
    {
      ...
      description:
        "Raising public awareness of intolerance and discrimination, encouraging inclusive and sustainable practices within communities.",
    ...
    },
    {
      ...
      description:
        "Promoting mutual respect and understanding between individuals of all faiths, ethnicities, and communities, thereby strengthening social cohesion.",
    ...
    },
    {
      title: "Collaboration",
      description:
        "Collaborating with charities, statutory bodies, and community groups to embed equality and human rights in civic life.",
