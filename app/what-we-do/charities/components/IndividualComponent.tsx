...
export default function IndividualContribution() {
    return (
        ...
        <div className=" mx-auto px-5 max-w-6xl">
          <div className="bg-white rounded-3xl grid grid-cols-1 lg:grid-cols-[1fr_450px] overflow-hidden shadow-lg relative mb-16 border-l-[5px] border-blue-500">
  ...
  Find Charity
          ...
          <div className="text-start">
            <h3 className="text-4xl font-bold text-gray-800 mb-4" style={{ fontFamily: "Unbounded" }}>Become a Partner Charity</h3>
