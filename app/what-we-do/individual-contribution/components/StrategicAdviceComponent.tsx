import { GetStrategicAdviceUser } from "@/assets";
          ...
          <div className="w-full lg:w-[70%] space-y-6 md:space-y-8 mt-8 lg:mt-0">
            <div>
              ...
              <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-3 md:mb-4">
                ...
                governance expertise. Your clients can be reassured that they&apos;re getting the best 
              ...
              <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                ...
                effectively. We can also work with you to tailor solutions where required, whether it&apos;s 
