  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4 text-[#64748B] leading-relaxed text-base md:text-[17px]">
        <p>
          ...
          the humanitarian causes among our global network of NGOs. 
          Our comprehensive industry knowledge, well-established 
          governance support, and adaptable solutions will work 
          together to maximize the positive effects of your business&apos;s 
          (and your employee&apos;s) charitable giving.
        </p>
        <p>
          Working together can make a substantial and fruitful shift in 
          the global communities that are most vital to your company 
          and its affiliates. When we work together, we contribute more.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="space-y-4 text-[#64748B] leading-relaxed text-base md:text-[17px]">
          <p>
            From aspiration to action, planning to outcomes, we are a 
            partner for companies that wish to contribute and leave 
      ...
      <div>
        ...
        <p className="text-[#64748B] leading-relaxed text-base md:text-[17px]">
          With our company account, you can manage all your giving online 
          from one place. We manage risk, reputation exposure, and 
          administration to make your giving secure and effective.
        </p>
      </div>
    </div>
  </div>
